...
public class Submission extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
        ...
        String userId = "GvNOl2xEAqZYYCsh224YGGlIjD52";
        //if (currentUser != null) {
            //String userId = currentUser.getUid();
            //set up firebaseRecyclerOptions
            FirebaseRecyclerOptions<CaseModel> options = new FirebaseRecyclerOptions.Builder<CaseModel>()
                    .setQuery(FirebaseDatabase.getInstance().getReference().child("Registered Users").child(userId).child("Cases"), CaseModel.class)
                    .build();
