...
public class caseAdapter extends FirebaseRecyclerAdapter<CaseModel,caseAdapter.CaseViewHolder> {

private Context context;
    public caseAdapter(@NonNull FirebaseRecyclerOptions<CaseModel> options , Context context) {
        super(options);
        this.context = context;
    }

    protected void onBindViewHolder(@NonNull CaseViewHolder holder, int position, @NonNull CaseModel model) {
