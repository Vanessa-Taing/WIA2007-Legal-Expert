...
public class lawyerActiveCase extends Fragment {
    private TextView textNoAcceptedCases;
    private RecyclerView recyclerView;
    private lawyerActiveCaseAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lawyer_active_case, container, false);

        textNoAcceptedCases = view.findViewById(R.id.textNoActiveCases);
        ...
        if (firebaseUser != null) {
            ...
            recyclerView = view.findViewById(R.id.RVactiveCase);
            activeCaseList = new ArrayList<>();
            adapter = new lawyerActiveCaseAdapter(activeCaseList,currentLawyerID);
                ...
                if (dataSnapshot.exists()) {
                    for (DataSnapshot senderSnapshot : dataSnapshot.getChildren()) {
                        ...
                        for (DataSnapshot caseSnapshot : senderSnapshot.getChildren()) {
                            ...
                            if ("Initiate".equals(status)||"OnGoing".equals(status)||"OnHold".equals(status)||"Complete".equals(status)) {
