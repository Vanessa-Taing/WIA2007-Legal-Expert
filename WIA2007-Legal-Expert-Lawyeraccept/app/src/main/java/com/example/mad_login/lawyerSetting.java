...
public class lawyerSetting extends AppCompatActivity {
    private TextView TVChangeProfilePic;
    private ImageView IVback, IVProfile;
    private Button btnUpdateEmail, btnUpdateProfile, btnUploadDocument;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUploadDocument = findViewById(R.id.btnUpload);
        IVback = findViewById(R.id.IVback);

        IVback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(lawyerSetting.this, lawyerProfile.class));
                finish();
            }
        });
        ...
        TVChangeProfilePic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(lawyerSetting.this, UploadProfilePic.class);
        ...
        btnUpdateEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(lawyerSetting.this, updateEmail.class));
                finish();
            }
        });
        ...
        btnUpdateProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(lawyerSetting.this, updateLawyerProfile.class));
                finish();
            }
        });
        ...
        btnUploadDocument.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(lawyerSetting.this, lawyerUploadDoc.class));
                finish();
            }
        });
