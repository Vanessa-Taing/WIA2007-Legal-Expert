...
public class AdapterCase extends FirebaseRecyclerAdapter<ModelCases, AdapterCase.myViewHolder> { //myViewHolder represents ViewHolder class used for individual items in RecyclerView

    private OnItemClickListener listener; //use to handle item click event in Recycler Viiew

    public AdapterCase(@NonNull FirebaseRecyclerOptions<ModelCases> options, OnItemClickListener listener) {
    ...
    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, int position, @NonNull ModelCases model) {
        //handle legal case
    ...
    public interface OnItemClickListener {
        void onItemClick(ModelCases model);
    }
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.documented_case_item,parent,false);
