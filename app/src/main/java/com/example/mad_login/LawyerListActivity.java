...
public class LawyerListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonCivil = findViewById(R.id.lbutton_civil);
        Button buttonConsumer = findViewById(R.id.lbutton_consumer);
        Button buttonContract = findViewById(R.id.lbutton_contract);
        Button buttonCriminal = findViewById(R.id.lbutton_criminal);
        Button buttonIslamic = findViewById(R.id.lbutton_islamic);
        Button buttonFamily = findViewById(R.id.lbutton_family);
        ...
        bottomNavigationView.getMenu().findItem(R.id.menu_lawyer).setChecked(true);
        bottomNavigationView.getMenu().findItem(R.id.menu_profile).setChecked(false);
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            @Override
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                int itemId = item.getItemId();
                Log.d("lawyerListActivity", "Selected item ID: " + itemId);
