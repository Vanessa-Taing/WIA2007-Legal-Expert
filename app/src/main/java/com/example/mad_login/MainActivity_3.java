...
public class MainActivity_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonCivil = findViewById(R.id.ubutton_civil);
        Button buttonConsumer = findViewById(R.id.ubutton_consumer);
        Button buttonContract = findViewById(R.id.ubutton_contract);
        Button buttonCriminal = findViewById(R.id.ubutton_criminal);
        Button buttonIslamic = findViewById(R.id.ubutton_islamic);
        Button buttonFamily = findViewById(R.id.ubutton_family);
        ...
        buttonCivil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("ButtonClick", "Civil button clicked");
                toggleFilter1("civil", buttonCivil);
            }
        });
        buttonConsumer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                toggleFilter1("consumer", buttonConsumer);
            }
        });
        ...
        buttonContract.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                toggleFilter1("contract",buttonContract);
            }
        });
        buttonCriminal.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View view) {
                toggleFilter1("criminal",buttonCriminal);
            }
        } );
        buttonFamily.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View view) {
                toggleFilter1("family",buttonFamily);
            }
        } );
        buttonIslamic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toggleFilter1("islamic", buttonIslamic);
            }
        });
    ...
    private void toggleFilter1(String filter, Button button) {
        Log.d("ToggleFilter", "Filter toggled: " + filter); // Log the filter value
        if (selectedFilters.contains(filter)) {
            selectedFilters.remove(filter);
            button.setBackgroundColor(ContextCompat.getColor(this, R.color.mainPurple));
            Log.d("ToggleFilter", "Removed filter: " + filter + ", Selected: " + selectedFilters.toString());
        } else {
            selectedFilters.add(filter);
            button.setBackgroundColor(ContextCompat.getColor(this, R.color.darkPurple));
            Log.d("ToggleFilter", "Added filter: " + filter + ", Selected: " + selectedFilters.toString());
        }

        Log.d("ToggleFilter", "Filter toggled: " + filter);
        applyFilters();
    }
