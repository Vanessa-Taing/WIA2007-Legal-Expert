...
public class documentedCaseModel {
    ...
    public documentedCaseModel() {
        // Default constructor required for calls to DataSnapshot.getValue(Case.class)
    }

    public documentedCaseModel(String caseName, String caseDescription, String caseType, String documentUrl) {
