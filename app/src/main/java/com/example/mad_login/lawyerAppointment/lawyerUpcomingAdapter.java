...
public class lawyerUpcomingAdapter extends RecyclerView.Adapter<lawyerUpcomingAdapter.ViewHolder> {
    ...
    public lawyerUpcomingAdapter(List<lawyerAppointmentModel> upComingList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.lawyer_upcoming_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        lawyerAppointmentModel appointment = upComingList.get(position);
