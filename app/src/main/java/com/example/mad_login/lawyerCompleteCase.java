...
public class lawyerCompleteCase extends Fragment {
    private TextView textNoCompleteCases;
    private RecyclerView recyclerView;
    private lawyerCompleteAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_lawyer_complete_case, container, false);

        textNoCompleteCases = view.findViewById(R.id.textNoCompletedCases);
        ...
        if (firebaseUser != null) {
            ...
            recyclerView = view.findViewById(R.id.RVCompleteCase);
            activeCaseList = new ArrayList<>();
            adapter = new lawyerCompleteAdapter(activeCaseList,currentLawyerID);
