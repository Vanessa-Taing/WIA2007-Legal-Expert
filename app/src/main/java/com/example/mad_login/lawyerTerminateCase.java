...
public class lawyerTerminateCase extends Fragment {

    private TextView textNoTerminateCases;
    private RecyclerView recyclerView;
    private lawyerTerminateAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_lawyer_terminate_case, container, false);
        ...
        if (firebaseUser != null) {
            ...
            recyclerView = view.findViewById(R.id.RVterminateCase);
            rejectedCaseList = new ArrayList<>() ;

            rejectedCaseList = new ArrayList<>() ;
            adapter = new lawyerTerminateAdapter(rejectedCaseList,currentLawyerID);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    for (DataSnapshot senderSnapshot : dataSnapshot.getChildren()) {
                        ...
                        Log.d("terminate", "sender ID in terminate case: " + senderID);
    ...
    private void fetchCaseDetails(String senderID , String caseID,String terminateReason) {
        ...
        casesRef.addListenerForSingleValueEvent(new ValueEventListener() {
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (casesSnapshot.exists()) {
                    ...
                    caseModel.setRejectionReason(terminateReason);
